// app/real-estate/recurring/actions.ts  (NEW — schedule CRUD + regenerate + mark-paid)
'use server'
...
// Confirm a forecast row as actually paid/received: flips it to 'actual',
// with optional amount/date correction (insurance & tax drift from estimate).
